...
router.post("/verify", async (req, res) => {
  try {
    ...
    // ✅ WHATSAPP MESSAGES TO CUSTOMER AND OWNER
    const customerPhone = "91" + booking.phone.slice(-10); // Format: 91XXXXXXXXXX
    const ownerPhone = "917709040404";
...
Payment Status: CONFIRMED ✅
    ...
    const ownerWhatsappLink =
      "https://wa.me/" + ownerPhone + "?text=" +
      encodeURIComponent(ownerMessage);
